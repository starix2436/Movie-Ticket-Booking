  ...
  <main>
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        ?>
          <img src="<?php if ($oIMDB->isReady) { echo $oIMDB->getPoster('small', true);}?>" alt="Bootstrap Themes"
          ...
          <div class="container">
            <div class="carousel-caption text-start">
              ...
              <p>
                <a class="btn btn-lg btn-primary" href="./pages/moviedetails.php?m_id=<?php echo $row['m_id'] ?>">BOOK NOW</a>
              </p>
            </div>
          </div>
        </div>
        ...
        ?>
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="./pages/moviedetails.php?m_id=<?php echo $row['m_id'] ?>">BOOK NOW</a></p>
            </div>
          </div>
        </div>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <button type="button" href="./pages/moviedetails.php?m_id=<?php echo $row['m_id'] ?>" class="btn btn-outline-primary">Book Now</button>
      ...
      <div class="row featurette">
        <div class="col-md-7 order-md-2">
          ...
          <button type="button" href="./pages/moviedetails.php?m_id=<?php echo $row['m_id'] ?>" class="btn btn-outline-primary" style="float:right">Book Now</button>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">
          <?php echo $row['m_name'] ?> <span class="text-muted">Checkmate.</span>
          </h2>
          <p class="lead">
          Barry, an Irish rogue, gets into a relationship with a rich widow and cheats his way to the top of the 18th-century British society, by assuming the identity of her dead husband.
          </p>
      ...
      <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="<?php if ($oIMDB->isReady) { echo $oIMDB->getPoster('small', true);}?>" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700"
          ...
          <div class="col-lg-6">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
              <button type="button" href="./pages/moviedetails.php?m_id=<?php echo $row['m_id'] ?>" class="btn btn-primary btn-lg px-4 me-md-2">BOOK NOW</button>
            </div>
          </div>
        </div>
      </div>
