...
--
INSERT INTO `cinema` (`c_id`, `c_name`, `ct_id`)
VALUES (1, 'c1', 1),
  (2, 'c2', 2);
-- --------------------------------------------------------
--
...
CREATE TABLE `cinema_hall` (
  `ch_id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
--
INSERT INTO `cinema_hall` (`ch_id`, `ch_name`, `ch_totalSeats`, `c_id`)
VALUES (1, 'c_abc', 10, 1),
  (2, 'c_abcd', 10, 2);
-- --------------------------------------------------------
--
...
CREATE TABLE `cinema_seat` (
  `cs_id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
--
CREATE TABLE `city` (
  `ct_id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
--
INSERT INTO `city` (`ct_id`, `ct_name`, `ct_state`, `ct_zipcode`)
VALUES (1, 'aa', 'aab', '10'),
  (2, 'ab', 'aab', '11');
-- --------------------------------------------------------
--
